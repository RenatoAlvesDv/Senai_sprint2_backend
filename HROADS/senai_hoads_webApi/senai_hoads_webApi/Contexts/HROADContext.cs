    ...
    public partial class HROADContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source = DESKTOP-T04AMV3; initial catalog=SENAI_HROADS_MANHA; user Id=sa; pwd=123456;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Classe>(entity =>
            {
                entity.HasKey(e => e.IdClasse)
                    .HasName("PK__Classes__0652AF79BBB54B3C");
            ...
            modelBuilder.Entity<ClassesHabilidade>(entity =>
            {
                ...
                entity.ToTable("Classes_Habilidades");

                entity.HasOne(d => d.IdClasseNavigation)
                    .WithMany()
                    .HasForeignKey(d => d.IdClasse)
                    .HasConstraintName("FK__Classes_H__IdCla__4BAC3F29");

                entity.HasOne(d => d.IdHabilidadeNavigation)
                    .WithMany()
                    .HasForeignKey(d => d.IdHabilidade)
                    .HasConstraintName("FK__Classes_H__IdHab__4CA06362");
            });

            modelBuilder.Entity<Habilidade>(entity =>
            {
                entity.HasKey(e => e.IdHabilidade)
                    .HasName("PK__Habilida__0DD4B30D7CED74B7");
                ...
                entity.HasOne(d => d.IdTipoHabilidadeNavigation)
                    ...
                    .HasConstraintName("FK__Habilidad__IdTip__49C3F6B7");
            });

            modelBuilder.Entity<Personagem>(entity =>
            {
                entity.HasKey(e => e.IdPersonagem)
                    .HasName("PK__Personag__4C5EDFB3F75D97D7");
            ...
            modelBuilder.Entity<TiposDeHabilidade>(entity =>
            {
                entity.HasKey(e => e.IdTipoHabilidade)
                    .HasName("PK__TiposDeH__8927B1B094E9EF6B");
            ...
            modelBuilder.Entity<TiposUsuario>(entity =>
            {
                entity.HasKey(e => e.IdTipoUsuario)
                    .HasName("PK__TiposUsu__CA04062BCA49D49A");
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasKey(e => e.IdUsuario)
                    .HasName("PK__Usuarios__5B65BF97E2D15B24");
